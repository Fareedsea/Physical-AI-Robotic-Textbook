...
const config = {
  ...
  organizationName: 'fareed241', // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/fareed241/Physical-AI-Robotic-Textbook/tree/main/',
        },
        blog: false,
        theme: {
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/fareed241/Physical-AI-Robotic-Textbook',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                to: '/docs/chapter-2-robotics-foundations',
              },
              {
                label: 'Chapter 3: Humanoid Systems',
                to: '/docs/chapter-3-humanoid-systems',
              },
            ],
          },
          {
